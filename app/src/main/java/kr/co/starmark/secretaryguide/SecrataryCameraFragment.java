...
public class SecrataryCameraFragment extends CameraFragment {

    public static final String TAG = SecrataryCameraFragment.class.getSimpleName();
    ...
    static SecrataryCameraFragment newInstance(boolean useFFC) {
        SecrataryCameraFragment f = new SecrataryCameraFragment();
    ...
    public void onCreate(Bundle state) {
        ...
        SimpleCameraHost host = builder.useFullBleedPreview(false)
               .useFrontFacingCamera(true)
               .recordingHint(CameraHost.RecordingHint.VIDEO_ONLY).build();
        setHost(host);
    }
...
//                zoom.setOnSeekBarChangeListener(SecrataryCameraFragment.this);
//            } else {
//                zoom.setEnabled(false);
//            }
